...
if (__wxConfig.accountInfo.appId === 'wx6f8bb0690e45d6ca') {
  exports.mainHost = mainHost = 'https://org.chengyisi.com';
  exports.secondaryHost = secondaryHost = 'https://console.chengyisi.com';
} else {
  exports.mainHost = mainHost = 'https://saas.jian1024.com';
  exports.secondaryHost = secondaryHost = 'https://console.jian1024.com';
}
exports.mainHost = mainHost;
exports.secondaryHost = secondaryHost;

console.log(__wxConfig, 'envVersion');

/***/ }),

/***/ "./src/services/global_data.js":
/*!*************************************!*\
  !*** ./src/services/global_data.js ***!
  \*************************************/
/*! no static exports found */
...
exports.requestFile = exports.requestText = exports.requestJsonAndCache = exports.requestJson = exports.request = exports.fetchRequest = undefined;
...
var fetchRequest = exports.fetchRequest = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(url, options, isFile) {
    var cacheEvict, hostType, targetUrl, opts, params, x, _params, _x4, token;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (options && options.cacheEvict) {
              cacheEvict = _extends({ type: 'window', key: url }, options.cacheEvict);

              (0, _storage.removeCacheDataAndTime)(cacheEvict.type, cacheEvict.key);
              (0, _storage.removeCacheDataAndTime)(cacheEvict.type, cacheEvict.key + ':ts');
            }
            ...
            targetUrl = hostType === 'org' ? _config.mainHost + url : _config.secondaryHost + url;
            opts = _extends({ credentials: 'include' }, options ? options : {});
              ...
              if (!opts.method || opts.method.match(/GET|DELETE/i)) {
                ...
                for (x in opts.data) {
                  if (opts.data[x] != null) {
                    ...
                    } else if (_typeof(opts.data[x]) === 'object') {
                ...
                if (opts.data && _typeof(opts.data) === 'object') {

                  //非GET、DELETE请求
                  _params = [];

                  for (_x4 in opts.data) {
                    if (opts.data[_x4] != null) {
                      if (opts.data[_x4] instanceof Array) {
                        _params.push(_x4 + "=" + encodeURI(opts.data[_x4].join(',')));
                      } else {
                        _params.push(_x4 + "=" + encodeURI(opts.data[_x4]));
                      }
                    }
                  }
                  if (!opts.header) {
                  ...
                  console.log('formData', opts.data, _params);
                  opts.data = _params.join("&");
                }
              }
            } else if (opts.body && _typeof(opts.body) === 'object') {
            ...
            //加入cookies
            token = hostType === 'org' ? _taroWeapp2.default.getStorageSync('x-auth-token-org') : _taroWeapp2.default.getStorageSync('x-auth-token-console');
            ...
            //请求机构端域名时加上身份标识
            if (hostType === 'org') {
              opts.header['x-tenant-id'] = _taroWeapp2.default.getStorageSync('x-tenant-id');
              opts.header['x-edu-code'] = _taroWeapp2.default.getStorageSync('x-edu-code');
              opts.header['x-member-id'] = _taroWeapp2.default.getStorageSync('x-member-id');
            }
            ...
            return _context.abrupt("return", downloadFile(_extends({ url: targetUrl }, opts)));

          case 14:
            return _context.abrupt("return", fetch(_extends({ url: targetUrl }, opts)));
...
var request = exports.request = function () {
  ...
  return function request(_x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();

var requestJson = exports.requestJson = function () {
  ...
  return function requestJson(_x7, _x8) {
    return _ref3.apply(this, arguments);
  };
}();

var requestJsonAndCache = exports.requestJsonAndCache = function () {
    ...
    return _regenerator2.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            cache = _extends({ key: url, type: 'window', timeout: 60000 }, options.cacheConfig);


            console.info(cache, "cac");
            (0, _storage.foreachStorage)();

            _context4.next = 5;
            return (0, _storage.getCacheDataByExpire)(cache.type, cache.key, cache.timeout);
          ...
          case 10:
            ...
            (0, _storage.setCacheDataAndTime)(cache.type, cache.key, data);
  ...
  return function requestJsonAndCache(_x9, _x10) {
    return _ref4.apply(this, arguments);
  };
}();

var requestText = exports.requestText = function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5(url, options) {
    var response, data, ret;
  ...
  return function requestText(_x11, _x12) {
    return _ref5.apply(this, arguments);
  };
}();

var requestFile = exports.requestFile = function () {
    ...
    return _regenerator2.default.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return fetchRequest(url, options, true);
  ...
  return function requestFile(_x13, _x14) {
...
var _storage = __webpack_require__(/*! ./storage */ "./src/services/storage.js");

var _config = __webpack_require__(/*! ./config */ "./src/services/config.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; } //import fetch from 'isomorphic-fetch';


//TODO 小程序的为头为header, 浏览器的为headers
var fetch = _taroWeapp2.default.request;
var downloadFile = _taroWeapp2.default.downloadFile;
...
function checkStatus(response, options) {
  ...
  if (response.header['x-auth-token']) {
    //将cookies缓存到本地
    var key = options.hostType === 'org' ? 'x-auth-token-org' : 'x-auth-token-console';
    _taroWeapp2.default.setStorageSync(key, response.header['x-auth-token']);
  }

  if (response.header['x-edu-code']) {
    _taroWeapp2.default.setStorageSync('x-edu-code', response.header['x-edu-code']);
  }
  ...
  if (response.statusCode >= 300) {
    var hostType = options.hostType;

    if (hostType === 'org') {
      // Taro.removeStorageSync('x-auth-token-org');
    }
  }
  var errorType = response.header['x-error-type'];
  var errorMessage = response.header['x-error-message'];
...
exports.setCacheDataAndTime = exports.getCacheDataByExpire = exports.removeCacheDataAndTime = exports.foreachStorage = undefined;

var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();

var _global_data = __webpack_require__(/*! ./global_data */ "./src/services/global_data.js");
...
var foreachStorage = exports.foreachStorage = function foreachStorage() {
  var defaultTime = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 60000;
  ...
  try {
    ...
    for (var _iterator = Object.entries(_global_data2.default)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (key.includes(':ts')) {
        var whenCached = (0, _global_data.get)(key);
        var age = Date.now() - whenCached;
        //默认清除1分钟以上的缓存
        if (age > defaultTime) {
          delete _global_data2.default[key];
          delete _global_data2.default[key.slice(0, key.length - 3)];
        }
      }
    }
...
var setCacheData = function setCacheData(type, key, value) {
  if (type == 'window') {
    /* if (!window.cache) {
       window.cache = {};
     }
...
var getCacheData = function getCacheData(type, key) {
  if (type == 'window') {
    /*    if (!window.cache) {
          return null;
        }
        return window.cache[key];*/
    return (0, _global_data.get)(key);
  } else {
    var storage = type == 'session' ? sessionStorage : localStorage;
...
var removeCacheData = function removeCacheData(type, key) {
  if (type !== 'window') {
    var storage = type === 'session' ? sessionStorage : localStorage;
    ...
    if (key instanceof Array) {
      ...
      try {
        for (var _iterator3 = key[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          delete _global_data2.default[_item];
          delete _global_data2.default[_item + ':ts'];
        }
      } catch (err) {
      ...
      delete _global_data2.default[key];
      delete _global_data2.default[key + ':ts'];
    }
  }
};

var removeCacheDataAndTime = exports.removeCacheDataAndTime = function removeCacheDataAndTime(type, key) {
  removeCacheData(type, key);
  removeCacheData(type, key + ':ts');
};

//返回storage数据
var getCacheDataByExpire = exports.getCacheDataByExpire = function getCacheDataByExpire(type, name, timeout) {
  console.info('get', type, name, timeout);
  var cacheKey = name;
  var cacheTimeKey = name + ':ts';

  var cacheTime = getCacheData(type, cacheTimeKey);
...
var setCacheDataAndTime = exports.setCacheDataAndTime = function setCacheDataAndTime(type, name, value) {
